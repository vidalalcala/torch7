...
TH_API void THTensor_(randperm)(THTensor *r_, THRandom *_random, long n);
...
TH_API void THTensor_(rand)(THTensor *r_, THRandom *_random, THLongStorage *size);
TH_API void THTensor_(randn)(THTensor *r_, THRandom *_random, THLongStorage *size);
